...
@interface SignDocDetailViewController ()
...
@implementation SignDocDetailViewController
...
-(void)sureContinue
{
    ...
    NSArray *keys = @[ @"Hy_mdid", @"Hy_IfLastTache", @"Hy_docid", @"Hy_userid", @"Hy_FWGZ", @"Hy_LDQFM", @"Hy_HQ", @"Hy_ZSDW", @"Hy_CSDW", @"Hy_SFGK",  @"Hy_WZFB", @"Hy_CSSH", @"Hy_BGSH",@"Hy_ZBDW", @"Hy_NGR",@"Hy_BT", @"Hy_MMDJ", @"Hy_HJ", @"Hy_LB", @"Hy_NF", @"Hy_BH", @"Hy_FS", @"Hy_JDR", @"Hy_YZRQ", @"Hy_TBYJ", @"Hy_NextTacheId", @"Hy_NextTacheName", @"Hy_NextTacheTransactor", @"Hy_NextTachePasser" ];
    ...
    continueProcessViewController.serviceName = @"SignReportContinuteProcess";
...
- (void)transferToNextStep{
    ...
    self.webServiceHelper = [[WebServiceHelper alloc] initWithUrl:strUrl method:@"SignReportContinuteProcess" nameSpace:WEBSERVICE_NAMESPACE  parameters:params delegate:self];
...
- (void)saveToProcess{
    ...
    NSArray *keys = @[ @"Hy_mdid", @"Hy_docid", @"Hy_userid", @"Hy_FWGZ", @"Hy_LDQFM", @"Hy_HQ", @"Hy_ZSDW", @"Hy_CSDW", @"Hy_SFGK", @"Hy_WZFB", @"Hy_CSSH", @"Hy_BGSH", @"Hy_ZBDW", @"Hy_NGR", @"Hy_BT", @"Hy_MMDJ", @"Hy_HJ", @"Hy_LB", @"Hy_NF", @"Hy_BH", @"Hy_FS", @"Hy_JDR", @"Hy_YZRQ", @"Hy_TBYJ"];
    
    NSString *strURL = [ServiceUrlString generateOAWebServiceUrl];
    NSString *params = [WebServiceHelper createParametersWithKeys:keys andValues:keyedArguments];
    self.webServiceHelper = [[WebServiceHelper alloc] initWithUrl:strURL method:@"SignReportSaveProcess" nameSpace:WEBSERVICE_NAMESPACE  parameters:params delegate:self];
...
- (IBAction)modifyData:(UIButton *)sender
{
    ...
    if (tag == 0) {
        ...
        contentEditViewController.serviceName = @"GetSignReportPaper";
        ...
        contentEditViewController.serviceName = @"GetSignReportUnit";
...
- (IBAction)selectOfficeDocumentSN:(id)sender{
    ...
    snSelectViewController.serviceName = @"GetSignReportType";
...
- (void)processWebData:(NSData *)webData
{
    ...
    if (self.webServiceType == kWebService_SaveProcess) {
        WebDataParserHelper *webDataHelper = [[WebDataParserHelper alloc] initWithFieldName:@"SignReportSaveProcessReturn" andWithJSONDelegate:self];
        ...
        WebDataParserHelper *webDataHelper = [[WebDataParserHelper alloc] initWithFieldName:@"SignReportContinuteProcessReturn" andWithJSONDelegate:self];
