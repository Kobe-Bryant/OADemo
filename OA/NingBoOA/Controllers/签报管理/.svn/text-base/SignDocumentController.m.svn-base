...
//
#import "SignDocumentController.h"
...
@interface SignDocumentController ()
@property (nonatomic,strong) UIPopoverController *popController;
@property(nonatomic,assign) NSInteger currentTag;
@end

@implementation SignDocumentController
...
- (void)viewDidLoad
{
    ...
    self.signListParser.serviceName = @"GetHandleSignReportList";
...
- (void)returnSelectResult:(NSString *)type selected:(NSInteger)row
{
    ...
    switch (row) {
        ...
        case 2:
            ...
            self.signListParser.type = @"date";
            self.signListParser.serviceName = @"GetDoneSignReportList";
            self.signListParser.showView = self.view;
            self.signListParser.delegate = self;
            [self.signListParser requestData];
            break;
        ...
        case 4:
            ...
            self.signListParser.serviceName = @"QuerySignReportList";
            self.signListParser.showView = self.view;
            self.signListParser.delegate = self;
            break;
...
- (void)didSelectSignDocListItem:(NSString *)docid process:(NSString *)name
{
    ...
    self.webServiceHelper = [[WebServiceHelper alloc] initWithUrl:strUrl method:@"GetSignReportDetail" nameSpace:WEBSERVICE_NAMESPACE  parameters:params delegate:self];
  
    [self.webServiceHelper runAndShowWaitingView:self.view withTipInfo:@"正在载入签报详情, 请稍候..."];
}
...
- (void)processWebData:(NSData *)webData
{
    ...
    WebDataParserHelper *webDataHelper = [[WebDataParserHelper alloc] initWithFieldName:@"GetSignReportDetailReturn" andWithJSONDelegate:self];
