//
//  QuerySignDocParser.m
//  NingBoOA
//
//  Created by 张仁松 on 13-9-30.
...
@implementation QuerySignDocParser
...
-(void)requestData
{
    ...
    NSString *params = [WebServiceHelper createParametersWithKey:@"HY_USERID" value:self.user, @"HY_TS", ONE_PAGE_SIZE, @"HY_START", [NSString stringWithFormat:@"%d",self.start],@"Hy_qssj",beginDate,@"Hy_jzsj",endDate,@"Hy_code",bh,@"Hy_bt",title,@"Hy_hj",urgent,@"Hy_department",depart,nil];
