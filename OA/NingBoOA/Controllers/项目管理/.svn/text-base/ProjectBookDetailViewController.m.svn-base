...
#import "SystemConfigContext.h"
@interface ProjectBookDetailViewController ()

@property (strong, nonatomic) UIPopoverController *popController;

@end

@implementation ProjectBookDetailViewController

- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    self = [super initWithNibName:nibNameOrNil bundle:nibBundleOrNil];
    if (self) {
        self.sitePublicAry = [NSMutableArray arrayWithCapacity:1];
    ...
    if ([self.competence isEqualToString:@"0"]) {
        ...
        for (NSString *ctrlEdit in editAry) {
            if ([ctrlEdit isEqualToString:@"Hy_FWGZ"]) {
                ...
                self.sitePublicBtn1.enabled = YES;
                
                self.sitePublicBtn2.enabled = YES;
            }
                ...
                CGRect frame = CGRectMake(534, 71, 204, 70);
                ...
                CGRect frame = CGRectMake(534, 351, 204, 70);
                ...
                CGRect frame = CGRectMake(530, 758, 204, 100);
                ...
                self.spjgBtn.hidden = NO;
                self.spjgBtn.enabled = YES;
                ...
                self.sprTxt.text = [userInfo objectForKey:@"name"];
            }
...
- (NSDictionary *)getValueData{
    ...
    [dicValues setValue:self.paperTxt.text forKey:@"Hy_XMGZ"];
    ...
    [dicValues setValue:self.sitePublishWay forKey:@"Hy_WZFB"];
...
- (void)loadEnterpriseAndProjectInfo{
...
- (void)viewDidLoad
{
    ...
    self.hqTxtView1.text = [self.infoDict objectForKey:@"Hy_HQ_Histroy"];
    ...
    self.spyjTxtView1.text = [self.infoDict objectForKey:@"Hy_Spyj"];
    ...
    self.sitePublishWay = [self.infoDict objectForKey:@"Hy_WZFB"];
    
    NSArray *wzfbWays = [self.sitePublishWay componentsSeparatedByString:@";"];
    if([wzfbWays containsObject:@"内网公告栏发表"]){
        [self.sitePublicBtn1 setImage:[UIImage imageNamed:@"com_btn_checked.png"] forState:UIControlStateNormal];
        [self.sitePublicAry addObject:@"内网公告栏发表"];
    }
    if([wzfbWays containsObject:@"外网公告栏发布"]) {
        [self.sitePublicBtn2 setImage:[UIImage imageNamed:@"com_btn_checked.png"] forState:UIControlStateNormal];
        [self.sitePublicAry addObject:@"外网公告栏发布"];
    }
    
    [self loadEnterpriseAndProjectInfo];
...
-(void)sureContinue
{
    ...
    NSArray *keys = @[ @"Hy_mdid", @"Hy_IfLastTache", @"Hy_docid", @"Hy_userid", @"Hy_XMGZ", @"Hy_LDQFM", @"Hy_HQ", @"Hy_ZSDW", @"Hy_CSDW", @"Hy_SFGK", @"Hy_WZFB", @"Hy_CSSH", @"Hy_BGSH", @"Hy_ZBDW", @"Hy_NGR", @"Hy_ZTC", @"Hy_BT", @"Hy_MMHJ", @"Hy_LB", @"Hy_NF", @"Hy_BH", @"Hy_FS", @"Hy_JDR", @"Hy_YZRQ", @"Hy_TBYJ", @"Hy_SPYJ", @"Hy_SPXX", @"Hy_NextTacheId", @"Hy_NextTacheName", @"Hy_NextTacheTransactor", @"Hy_NextTachePasser" ];
    ...
    continueProcessViewController.serviceName = @"reportBookContinuteProcess";
...
- (void)transferToNextStep{
    ...
    self.webServiceHelper = [[WebServiceHelper alloc] initWithUrl:strUrl method:@"reportBookContinuteProcess" nameSpace:WEBSERVICE_NAMESPACE  parameters:params delegate:self];
...
- (void)saveToProcess{
    ...
    NSDictionary *keyedArguments = [self getValueData];
    NSArray *keys = @[ @"Hy_mdid", @"Hy_docid", @"Hy_userid", @"Hy_XMGZ", @"Hy_LDQFM", @"Hy_HQ", @"Hy_ZSDW", @"Hy_CSDW", @"Hy_SFGK", @"Hy_WZFB", @"Hy_CSSH", @"Hy_BGSH", @"Hy_ZBDW", @"Hy_NGR", @"Hy_ZTC", @"Hy_BT", @"Hy_MMHJ", @"Hy_LB", @"Hy_NF", @"Hy_BH", @"Hy_FS", @"Hy_JDR", @"Hy_YZRQ", @"Hy_TBYJ", @"Hy_SPYJ", @"Hy_SPXX" ];
    
    NSString *strURL = [ServiceUrlString generateOAWebServiceUrl];
    NSString *params = [WebServiceHelper createParametersWithKeys:keys andValues:keyedArguments];
    self.webServiceHelper = [[WebServiceHelper alloc] initWithUrl:strURL method:@"reportBookSaveProcess" nameSpace:WEBSERVICE_NAMESPACE  parameters:params delegate:self];
...
- (IBAction)modifyData:(UIButton *)sender
{
    ...
    if (tag == 0) {
        ...
        contentEditViewController.serviceName = @"reportBookPaper";
        ...
        contentEditViewController.serviceName = @"reportBookUnit";
        ...
        contentEditViewController.serviceName = @"reportBookTopic";
...
- (IBAction)selectOfficeDocumentSN:(id)sender{
    ...
    snSelectViewController.serviceName = @"reportTableFileType";
...
- (IBAction)multiBtnSelect:(UIButton *)btn{
    ...
    NSString *shortTitle = [buttonTitle substringToIndex:2];
    NSMutableString *sitePublishStr = [NSMutableString stringWithCapacity:1];
    
    NSRange range = [self.sitePublishWay rangeOfString:shortTitle];
    if (NSNotFound == range.location){
        if([buttonTitle isEqualToString:@"内网发表"]) {
            [self.sitePublicAry addObject:@"内网公告栏发表"];
        }
        else {
            [self.sitePublicAry addObject:@"外网公告栏发布"];
        }
        [btn setImage:[UIImage imageNamed:@"com_btn_checked.png"] forState:UIControlStateNormal];
    }
    else {
        if([buttonTitle isEqualToString:@"外网发布"]) {
            [self.sitePublicAry removeObject:@"外网公告栏发布"];
            
        }
        else {
            [self.sitePublicAry removeObject:@"内网公告栏发表"];
        }
        [btn setImage:[UIImage imageNamed:@"com_btn_check.png"] forState:UIControlStateNormal];
    }
    
    for (NSString *sitePublishTitle in self.sitePublicAry) {
        if([sitePublishStr length] < 1) {
            [sitePublishStr appendString:sitePublishTitle];
        }
        else {
            [sitePublishStr appendFormat:@";%@",sitePublishTitle];
        }
    }
    
    self.sitePublishWay = sitePublishStr;
}
...
- (void)processWebData:(NSData *)webData
{
    ...
    if (self.webServiceType == kWebService_SaveProcess) {
        WebDataParserHelper *webDataHelper = [[WebDataParserHelper alloc] initWithFieldName:@"reportBookSaveProcessReturn" andWithJSONDelegate:self];
        ...
        WebDataParserHelper *webDataHelper = [[WebDataParserHelper alloc] initWithFieldName:@"reportBookContinuteProcessReturn" andWithJSONDelegate:self];
