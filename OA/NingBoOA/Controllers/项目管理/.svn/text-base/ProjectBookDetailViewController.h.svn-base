...
@interface ProjectBookDetailViewController : BaseViewController<UIAlertViewDelegate,UITableViewDataSource,UITableViewDelegate,WordsDelegate,GetOfficeDocumentSNDelegate,ContentEditDelegate,PopupDateDelegate>
...
@property (strong, nonatomic) IBOutlet UIButton    *spjgBtn;
