...
@interface ProjectCheckDetailViewController : BaseViewController<UIAlertViewDelegate,UITableViewDataSource,UITableViewDelegate,WordsDelegate,GetOfficeDocumentSNDelegate,ContentEditDelegate,PopupDateDelegate> 
