...
@interface ProjectRegistryDetailViewController : BaseViewController<UIAlertViewDelegate,UITableViewDataSource,UITableViewDelegate,WordsDelegate,GetOfficeDocumentSNDelegate,ContentEditDelegate,PopupDateDelegate> 
