...
enum AlertyType {
    save,endAction,endScucess,endFail =5
};


@interface ProjectDetailViewController : BaseViewController<UIAlertViewDelegate,UITableViewDataSource,UITableViewDelegate,WordsDelegate,ContentEditDelegate,PopupDateDelegate> {
    enum AlertyType alertType;
}
...
@property (strong, nonatomic) IBOutlet UISegmentedControl *sitePublicCtr;
...
@property (strong, nonatomic) IBOutlet UITextField *topicTxt;
...
@property (strong, nonatomic) IBOutlet UITextField *postId;
