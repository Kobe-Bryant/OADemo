...
@interface ProjectTableDetailViewController ()

@property (strong, nonatomic) UIPopoverController *popController;

@end

@implementation ProjectTableDetailViewController
...
- (void)setControlEdit{
    ...
    [scrollView setContentSize:CGSizeMake(768, 2400)];
...
- (IBAction)modifyData:(UIButton *)sender
{
    ...
    if (tag == 0) {
        ...
        contentEditViewController.serviceName = @"reportTablePaper";
    ...
    else if(tag == 1 )
    {
        ...
        contentEditViewController.serviceName = @"reportTableUnit";
