...
@protocol HandleProjectDetail <NSObject>

- (void)didSelectProjectListItem:(NSString *)docid process:(NSString *)name;
- (void)loadMoreList;
@end

@interface ProjectListParser : NSObject<UITableViewDataSource,UITableViewDelegate,UIScrollViewDelegate>
...
@property(nonatomic,weak)   id<HandleProjectDetail>delegate;
