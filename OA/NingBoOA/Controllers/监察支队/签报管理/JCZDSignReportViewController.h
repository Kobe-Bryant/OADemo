...
@interface JCZDSignReportViewController : BaseViewController<FileManagerDelegate,HandleSignDocDetail,PopupDateDelegate,WordsDelegate,UITextFieldDelegate>
{
...
@property (weak, nonatomic)  id<BackProtocol> delegate;
