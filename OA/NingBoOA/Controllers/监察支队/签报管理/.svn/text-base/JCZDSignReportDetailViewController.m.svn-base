...
@interface JCZDSignReportDetailViewController ()
...
@implementation JCZDSignReportDetailViewController
    ...
    if ([self.competence isEqualToString:@"0"]) {
        ...
        for (NSString *ctrlEdit in editAry) {
            ...
            if ([ctrlEdit isEqualToString:@"Hy_FWGZ"]) {
                ...
                CGRect frame = CGRectMake(530, 718, 208, 100);
...
-(void)sureContinue
{
    ...
    NSArray *keys = @[@"Hy_mdid",@"Hy_IfLastTache",@"Hy_docid", @"Hy_userid", @"Hy_FWGZ", @"Hy_LDQFM", @"Hy_HQ", @"Hy_ZSDW", @"Hy_CSDW", @"Hy_SFGK",  @"Hy_KSSH", @"Hy_BGSH", @"Hy_ZBDW", @"Hy_NGR", @"Hy_BT", @"Hy_MMDJ", @"Hy_HJ", @"Hy_LB", @"Hy_NF", @"Hy_BH", @"Hy_FS", @"Hy_JDR", @"Hy_YZRQ", @"Hy_TBYJ", @"Hy_NextTacheId", @"Hy_NextTacheName", @"Hy_NextTacheTransactor", @"Hy_NextTachePasser" ];
    ...
    continueProcessViewController.serviceName = @"JCZDSignReportContinuteProcess";
...
- (void)transferToNextStep{
    ...
    self.webServiceHelper = [[WebServiceHelper alloc] initWithUrl:strUrl method:@"JCZDSignReportContinuteProcess" nameSpace:WEBSERVICE_NAMESPACE  parameters:params delegate:self];
...
- (void)saveToProcess{
    ...
    NSDictionary *keyedArguments = [self getValueData];
    NSArray *keys = @[ @"Hy_mdid", @"Hy_docid", @"Hy_userid", @"Hy_FWGZ",  @"Hy_LDQFM", @"Hy_HQ", @"Hy_ZSDW", @"Hy_CSDW", @"Hy_SFGK", @"Hy_KSSH", @"Hy_BGSH", @"Hy_ZBDW", @"Hy_NGR", @"Hy_BT", @"Hy_MMDJ", @"Hy_HJ", @"Hy_LB", @"Hy_NF", @"Hy_BH", @"Hy_FS", @"Hy_JDR", @"Hy_YZRQ", @"Hy_TBYJ" ];
    
    NSString *strURL = [ServiceUrlString generateOAWebServiceUrl];
    NSString *params = [WebServiceHelper createParametersWithKeys:keys andValues:keyedArguments];
    
    self.webServiceHelper = [[WebServiceHelper alloc] initWithUrl:strURL method:@"JCZDSignReportSaveProcess" nameSpace:WEBSERVICE_NAMESPACE  parameters:params delegate:self];
...
- (IBAction)modifyData:(UIButton *)sender
{
    ...
    if (tag == 0) {
        ...
        contentEditViewController.serviceName = @"JCZDSignReportPaper";
        ...
        contentEditViewController.serviceName = @"JCZDSignReportUnit";
...
- (IBAction)selectOfficeDocumentSN:(id)sender{
    ...
    snSelectViewController.serviceName = @"JCZDSignReportType";
...
- (void)processWebData:(NSData *)webData
{
    ...
    if (self.webServiceType == kWebService_SaveProcess) {
        WebDataParserHelper *webDataHelper = [[WebDataParserHelper alloc] initWithFieldName:@"JCZDSignReportSaveProcessReturn" andWithJSONDelegate:self];
        ...
        WebDataParserHelper *webDataHelper = [[WebDataParserHelper alloc] initWithFieldName:@"JCZDSignReportContinuteProcessReturn" andWithJSONDelegate:self];
