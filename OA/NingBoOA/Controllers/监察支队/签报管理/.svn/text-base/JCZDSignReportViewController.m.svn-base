...
@interface JCZDSignReportViewController ()
@property (nonatomic,strong) UIPopoverController *popController;
@property(nonatomic,assign) NSInteger currentTag;
@end

@implementation JCZDSignReportViewController
...
- (void)viewDidLoad
{
    ...
    self.signListParser.serviceName = @"JCZDHandleSignReportList";
...
- (void)returnSelectResult:(NSString *)type selected:(NSInteger)row
{
    ...
    switch (row) {
        ...
        case 2:
            ...
            self.signListParser.type = @"date";
            self.signListParser.serviceName = @"JCZDDoneSignReportList";
            self.signListParser.showView = self.view;
            self.signListParser.delegate = self;
            [self.signListParser requestData];
            break;
        ...
        case 4:
            ...
            self.signListParser.serviceName = @"JCZDQuerySignReportList";
            self.signListParser.showView = self.view;
            self.signListParser.delegate = self;
            break;
...
- (void)didSelectSignDocListItem:(NSString *)docid process:(NSString *)name
{
    ...
    self.webServiceHelper = [[WebServiceHelper alloc] initWithUrl:strUrl method:@"JCZDSignReportDetail" nameSpace:WEBSERVICE_NAMESPACE  parameters:params delegate:self];
...
- (void)processWebData:(NSData *)webData
{
    ...
    WebDataParserHelper *webDataHelper = [[WebDataParserHelper alloc] initWithFieldName:@"JCZDSignReportDetailReturn" andWithJSONDelegate:self];
