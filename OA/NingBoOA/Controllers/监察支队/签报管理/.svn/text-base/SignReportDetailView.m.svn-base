...
#import "SignReportDetailView.h"
#import "UIView+ZXQuartz.h"
@implementation SignReportDetailView
...
- (void)drawRect:(CGRect)rect
{
    ...
    [self drawFrameRectangele:CGRectMake(20, 70, 728, 790)];
    
    [self drawFillRectangel:CGRectMake(21, 71, 138, 788)];
    [self drawFillRectangel:CGRectMake(385, 71, 138, 438)];
    [self drawFillRectangel:CGRectMake(385, 591, 138, 38)];
    [self drawFillRectangel:CGRectMake(385, 671, 138, 38)];
...
//    [self drawLineFrom:CGPointMake(20, 590) to:CGPointMake(748, 590)];
    ...
    [self drawLineFrom:CGPointMake(160, 70) to:CGPointMake(160, 860)];
    [self drawLineFrom:CGPointMake(384, 70) to:CGPointMake(384, 510)];
    [self drawLineFrom:CGPointMake(524, 70) to:CGPointMake(524, 510)];
    [self drawLineFrom:CGPointMake(384, 590) to:CGPointMake(384, 630)];
    [self drawLineFrom:CGPointMake(524, 590) to:CGPointMake(524, 630)];
    [self drawLineFrom:CGPointMake(384, 670) to:CGPointMake(384, 710)];
    [self drawLineFrom:CGPointMake(524, 670) to:CGPointMake(524, 710)];
}
