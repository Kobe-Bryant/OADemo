...
@interface JCZDFileInDetailViewController : BaseViewController<UIAlertViewDelegate,HandleGWDelegate,UITableViewDataSource,UITableViewDelegate,PopupDateDelegate,GetOfficeDocumentSNDelegate,WordsDelegate,ContentEditDelegate,UITextViewDelegate>
