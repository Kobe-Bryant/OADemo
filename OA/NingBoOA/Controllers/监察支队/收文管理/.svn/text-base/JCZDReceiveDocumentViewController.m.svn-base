...
@interface JCZDReceiveDocumentViewController ()
@property (nonatomic,strong) UIPopoverController *popController;
@end

@implementation JCZDReceiveDocumentViewController
...
- (void)viewDidLoad
{
   ...
   self.inListParser.type = @"date";
    ...
    self.inListParser.serviceName = @"JCZDHandleReceiveDocument";
...
- (void)returnSelectResult:(NSString *)type selected:(NSInteger)row
{
    ...
    switch (row) {
        ...
        case 2:
            ...
            self.inListParser.serviceName = @"JCZDDoneReceiveDocument";
            self.inListParser.delegate = self;
            self.inListParser.showView = self.view;
            [self.inListParser requestData];
            break;
        ...
        case 3:
            ...
            self.inListParser.serviceName = @"JCZDAllReceiveDocument";
            self.inListParser.delegate = self;
            self.inListParser.showView = self.view;
            [self.inListParser requestData];
            break;
        ...
        case 4:
            ...
            self.inListParser.serviceName = @"JCZDToDateReceiveDocument";
            self.inListParser.showView = self.view;
            self.inListParser.delegate = self;
            [self.inListParser requestData];
            break;
        ...
        case 5:
            ...
            self.inListParser.serviceName = @"JCZDInquiryReceiveDocument";
            self.inListParser.showView = self.view;
            self.inListParser.delegate = self;
            isShow = YES;
            break;
...
- (void)didSelectFileInListItem:(NSString *)docid process:(NSString *)name{
    ...
    self.webServiceHelper = [[WebServiceHelper alloc] initWithUrl:strUrl method:@"JCZDReceiveDocumentInfo" nameSpace:WEBSERVICE_NAMESPACE  parameters:params delegate:self];
...
- (void)loadFileInDetailViewProcess:(NSString *)name competence:(NSString *)status {
    ...
    JCZDFileInDetailViewController *fileInDetailViewController = [[JCZDFileInDetailViewController alloc] initWithNibName:@"JCZDFileInDetailViewController" bundle:nil];
...
- (void)processWebData:(NSData *)webData
{
    ...
    WebDataParserHelper *webDataHelper = [[WebDataParserHelper alloc] initWithFieldName:@"JCZDReceiveDocumentInfoReturn" andWithJSONDelegate:self];
