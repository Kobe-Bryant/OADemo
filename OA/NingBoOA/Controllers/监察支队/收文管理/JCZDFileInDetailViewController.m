    ...
    if ([self.competence isEqualToString:@"0"]) {
        ...
        for (NSString *ctrlEdit in editAry) {
            ...
            if ([ctrlEdit isEqualToString:@"Hy_FWGZ"]) {
                ...
                CGRect frame = CGRectMake(170, 382, 204, 58);
                ...
                CGRect frame = CGRectMake(534, 382, 204, 58);
                ...
                CGRect frame = CGRectMake(530, 738, 208, 100);
...
- (NSDictionary *)getValueData{
    ...
    [dicValues setValue:self.auditTxtView.text forKey:@"Hy_KSYJ"];
...
- (void)viewDidLoad
{
    ...
    self.lwlxTxt.text = [self.infoDict objectForKey:@"Hy_lwwh"];
...
-(void)sureContinue
{
    ...
    NSArray *keys = @[@"Hy_mdid", @"Hy_IfLastTache",@"Hy_docid", @"Hy_userid", @"Hy_SWLY", @"Hy_YEAR", @"Hy_BH", @"Hy_DJR", @"Hy_DJRQ", @"Hy_MJ", @"Hy_SWRQ", @"Hy_HJ", @"Hy_LB", @"Hy_BT", @"Hy_LZFS",@"Hy_LWLB", @"Hy_LWNF", @"Hy_LWBH", @"Hy_pages", @"Hy_numbers", @"Hy_SFGD", @"Hy_BLQX", @"Hy_BGSYJ", @"Hy_LDYJ", @"Hy_SWFFYJ", @"Hy_KSYJ",@"Hy_TBYJ",@"Hy_NextTacheId", @"Hy_NextTacheName", @"Hy_NextTacheTransactor", @"Hy_NextTachePasser" ];
    ...
    continueProcessViewController.parameterDictionary = valueDict;
    continueProcessViewController.paramsAry = keys;
    continueProcessViewController.currentProcessName = self.process;
    continueProcessViewController.serviceName = @"JCZDReceiveContinuteProcess";
...
- (void)transferToNextStep{
    ...
    self.webServiceHelper = [[WebServiceHelper alloc] initWithUrl:strURL method:@"JCZDReceiveContinuteProcess" nameSpace:WEBSERVICE_NAMESPACE  parameters:params delegate:self];
...
- (void)saveToProcess{
    ...
    NSArray *keys = @[ @"Hy_mdid", @"Hy_docid", @"Hy_userid", @"Hy_SWLY", @"HY_YEAR", @"Hy_bh", @"Hy_DJR", @"Hy_DJRQ", @"Hy_MJ", @"Hy_SWRQ", @"Hy_HJ", @"Hy_LB", @"Hy_BT", @"Hy_LZFS", @"Hy_LWLB", @"Hy_LWNF", @"Hy_LWBH" ,@"Hy_pages", @"Hy_numbers", @"Hy_SFGD", @"Hy_BLQX", @"Hy_BGSYJ", @"Hy_LDYJ", @"Hy_SWFFYJ", @"Hy_KSYJ", @"Hy_TBYJ" ];
    
    NSString *strURL = [ServiceUrlString generateOAWebServiceUrl];
    NSString *params = [WebServiceHelper createParametersWithKeys:keys andValues:keyedArguments];
    
    self.webServiceHelper = [[WebServiceHelper alloc] initWithUrl:strURL method:@"JCZDReceiveSaveProcess" nameSpace:WEBSERVICE_NAMESPACE  parameters:params delegate:self];
...
- (IBAction)modifyData:(UIButton *)sender
{
    ...
    if(tag == 1) {
        ...
        //收文分发
        contentEditViewController.editorType = KEditor_Type_SRYJ;
        contentEditViewController.editorTitle = @"收文分发";
...
- (IBAction)selectOfficeDocumentSN:(id)sender{
    ...
    snSelectViewController.serviceName = @"JCZDFileInResource";
...
- (void)processWebData:(NSData *)webData andTag:(NSInteger)tag
{
    ...
    if (self.webServiceType == kWebService_SaveProcess) {
        WebDataParserHelper *webDataHelper = [[WebDataParserHelper alloc] initWithFieldName:@"JCZDReceiveSaveProcessReturn" andWithJSONDelegate:self];
        ...
        WebDataParserHelper *webDataHelper = [[WebDataParserHelper alloc] initWithFieldName:@"JCZDReceiveContinuteProcessReturn" andWithJSONDelegate:self];
