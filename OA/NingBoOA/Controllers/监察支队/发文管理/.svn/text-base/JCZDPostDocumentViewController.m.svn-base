...
@interface JCZDPostDocumentViewController ()
@property (nonatomic,strong) UIPopoverController *popController;
@end

@implementation JCZDPostDocumentViewController
...
- (void)viewDidLoad
{
    ...
    self.outListParser.serviceName = @"JCZDHandlePostDocument";
...
- (void)returnSelectResult:(NSString *)type selected:(NSInteger)row
{
    ...
    switch (row) {            
        ...
        case 2:
            ...
            self.outListParser.type = @"date";
            self.outListParser.serviceName = @"JCZDDonePostDocument";
            self.outListParser.showView = self.view;
            self.outListParser.delegate = self;
            [self.outListParser requestData];
            break;
        ...
        case 4:
            ...
            self.outListParser.serviceName = @"JCZDPostDocumentBackPercent";
            self.outListParser.showView = self.view;
            [self.outListParser requestData];
            break;
        ...
        case 5:
            ...
            self.outListParser.serviceName = @"JCZDInquiryPostDocument";
            self.outListParser.showView = self.view;
            self.outListParser.delegate = self;
            break;
...
- (void)didSelectFileOutListItem:(NSString *)docid process:(NSString *)name{
    ...
    self.webServiceHelper = [[WebServiceHelper alloc] initWithUrl:strUrl method:@"JCZDPostDocumentInfo" nameSpace:WEBSERVICE_NAMESPACE  parameters:params delegate:self];
...
- (void)loadFileOutDetailViewProcess:(NSString *)name competence:(NSString *)status{
    ...
    JCZDFileOutDetailViewController *fileOutDetailViewController = [[JCZDFileOutDetailViewController alloc] initWithNibName:@"JCZDFileOutDetailViewController" bundle:nil];
...
- (void)processWebData:(NSData *)webData
{
    ...
    WebDataParserHelper *webDataHelper = [[WebDataParserHelper alloc] initWithFieldName:@"JCZDPostDocumentInfoReturn" andWithJSONDelegate:self];
