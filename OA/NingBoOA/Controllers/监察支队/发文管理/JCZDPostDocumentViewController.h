...
@interface JCZDPostDocumentViewController : BaseViewController<FileManagerDelegate,HandleFileOutDetail,UITextFieldDelegate,PopupDateDelegate,WordsDelegate>
