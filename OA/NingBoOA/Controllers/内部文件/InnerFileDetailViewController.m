...
@interface InnerFileDetailViewController ()
...
@implementation InnerFileDetailViewController
...
- (void)setControlEdit{
    ...
    [scrollView setContentSize:CGSizeMake(768, 1120)];
    ...
    if ([self.competence isEqualToString:@"0"]) {
        ...
        for (NSString *ctrlEdit in editAry) {
            ...
            if ([ctrlEdit isEqualToString:@"Hy_FWGZ"]) {
                ...
                CGRect frame = CGRectMake(530, 198, 208, 110);
                ...
                CGRect frame = CGRectMake(530, 598, 208, 110);
...
-(void)sureContinue
{
    ...
    NSArray *keys = @[ @"Hy_mdid", @"Hy_IfLastTache",@"Hy_docid", @"Hy_userid", @"Hy_FWGZ", @"Hy_ZSDW", @"Hy_CSDW", @"Hy_SFGK", @"Hy_QCRQ", @"Hy_CSHG", @"Hy_ZBDW", @"Hy_NGR", @"Hy_BT", @"Hy_MMDJ", @"Hy_HJ", @"Hy_LB", @"Hy_NF", @"Hy_BH", @"Hy_FS", @"Hy_JDR", @"Hy_YZRQ", @"Hy_TBYJ", @"Hy_NextTacheId", @"Hy_NextTacheName", @"Hy_NextTacheTransactor", @"Hy_NextTachePasser" ];
    ...
    continueProcessViewController.serviceName = @"FileInsidetContinuteProcess";
...
- (void)transferToNextStep{
    ...
    self.webServiceHelper = [[WebServiceHelper alloc] initWithUrl:strUrl method:@"FileInsidetContinuteProcess" nameSpace:WEBSERVICE_NAMESPACE  parameters:params delegate:self];
...
- (void)saveToProcess{
    ...
    NSArray *keys = @[ @"Hy_mdid", @"Hy_docid", @"Hy_userid", @"Hy_FWGZ", @"Hy_ZSDW", @"Hy_CSDW", @"Hy_SFGK", @"Hy_QCRQ", @"Hy_CSHG", @"Hy_ZBDW", @"Hy_NGR", @"Hy_BT", @"Hy_MMDJ", @"Hy_HJ", @"Hy_LB", @"Hy_NF", @"Hy_BH", @"Hy_FS", @"Hy_JDR", @"Hy_YZRQ", @"Hy_TBYJ" ];
    
    NSString *strURL = [ServiceUrlString generateOAWebServiceUrl];
    NSString *params = [WebServiceHelper createParametersWithKeys:keys andValues:keyedArguments];
    
    self.webServiceHelper = [[WebServiceHelper alloc] initWithUrl:strURL method:@"FileInsidetSaveProcess" nameSpace:WEBSERVICE_NAMESPACE  parameters:params delegate:self];
...
- (IBAction)modifyData:(UIButton *)sender
{
    ...
    if (tag == 0) {
        ...
        contentEditViewController.serviceName = @"GetFileInsidetPaper";
    ...
    else if(tag == 1 )
    {
        ...
        contentEditViewController.serviceName = @"GetFileInsidetUnit";
...
- (IBAction)selectOfficeDocumentSN:(id)sender{
    ...
    snSelectViewController.serviceName = @"GetFileInsidetType";
...
- (void)processWebData:(NSData *)webData
{
    ...
    if (self.webServiceType == kWebService_SaveProcess) {
        WebDataParserHelper *webDataHelper = [[WebDataParserHelper alloc] initWithFieldName:@"FileInsidetSaveProcessReturn" andWithJSONDelegate:self];
        ...
        WebDataParserHelper *webDataHelper = [[WebDataParserHelper alloc] initWithFieldName:@"FileInsidetContinuteProcessReturn" andWithJSONDelegate:self];
