...
@interface DeptFileDetailViewController ()
...
@implementation DeptFileDetailViewController
...
-(void)sureContinue
{
    ...
    continueProcessViewController.serviceName = @"FileDeptContinuteProcess";
...
- (void)transferToNextStep{
    ...
    self.webServiceHelper = [[WebServiceHelper alloc] initWithUrl:strUrl method:@"FileDeptContinuteProcess" nameSpace:WEBSERVICE_NAMESPACE  parameters:params delegate:self];
...
- (void)saveToProcess{
    ...
    self.webServiceHelper = [[WebServiceHelper alloc] initWithUrl:strURL method:@"FileDeptSaveProcess" nameSpace:WEBSERVICE_NAMESPACE  parameters:params delegate:self];
...
- (IBAction)modifyData:(UIButton *)sender
{
    ...
    if (tag == 0) {
        ...
        contentEditViewController.serviceName = @"GetFileDeptPaper";
    ...
    else if(tag == 1 )
    {
        ...
        contentEditViewController.serviceName = @"GetFileDeptUnit";
...
- (IBAction)selectOfficeDocumentSN:(id)sender{
    ...
    snSelectViewController.serviceName = @"GetFileDeptType";
...
- (void)processWebData:(NSData *)webData
{
    ...
    if (self.webServiceType == kWebService_SaveProcess) {
        WebDataParserHelper *webDataHelper = [[WebDataParserHelper alloc] initWithFieldName:@"FileDeptSaveProcessReturn" andWithJSONDelegate:self];
        ...
        WebDataParserHelper *webDataHelper = [[WebDataParserHelper alloc] initWithFieldName:@"FileDeptContinuteProcessReturn" andWithJSONDelegate:self];
