...
@implementation DeptFileDoneParser
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([self.serviceName isEqualToString:kServiceName_Done])
    {
        ...
        if (cell == nil)
        {
            NSArray *nibTableCells = [[NSBundle mainBundle] loadNibNamed:@"DeptFileListCell"owner:nil options:nil];
