...
@interface NoticeListViewController ()<UITextFieldDelegate,PopupDateDelegate>
...
- (void)requestWebData {
    ...
    NSString *params = [WebServiceHelper createParametersWithKey:@"IdentifyCode" value:@"NBEPB", @"ClassGuid",@"530c803c-8b70-4823-8b63-cf5553af21a4",@"SearchKey",self.searchKey,@"PageSize",@"10",@"PageSizeSpecified",@"true",@"PageIndex",[NSString stringWithFormat:@"%d",self.start],@"PageIndexSpecified",@"true",nil];
