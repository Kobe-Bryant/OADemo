...
@interface ApplicationDetailViewController : BaseViewController<UIAlertViewDelegate,HandleGWDelegate,UITableViewDataSource,UITableViewDelegate,PopupDateDelegate,GetOfficeDocumentSNDelegate,WordsDelegate,ContentEditDelegate>
...
@property (strong, nonatomic) IBOutlet UITextView  *complainTxtView1;
@property (strong, nonatomic) IBOutlet UITextView  *complainTxtView;
@property (strong, nonatomic) IBOutlet UIButton    *inputComplain;
@property (strong, nonatomic) IBOutlet UIButton    *clearComplain;
