...
- (void)setControlEdit{
    ...
    [scrollView setContentSize:CGSizeMake(768, 1950)];
    ...
    if ([self.competence isEqualToString:@"0"]) {
        ...
        if ([self.process isEqualToString:@"登记"]) {
        ...
        for (NSString *ctrlEdit in editAry) {
            if ([ctrlEdit isEqualToString:@"Hy_FWGZ"]) {
                ...
                CGRect frame = CGRectMake(530, 468, 204, 58);
                self.complainTxtView1.frame = frame;
                
                self.complainTxtView.layer.borderColor = [UIColor colorWithRed:229.f/255.f green:229.f/255.f blue:229.f/255.f alpha:1.0].CGColor;
                self.complainTxtView.layer.borderWidth =1.5;
                self.complainTxtView.layer.cornerRadius =6.0;
                
                self.inputComplain.hidden = NO;
                self.inputComplain.enabled = YES;
                self.clearComplain.hidden = NO;
                self.clearComplain.enabled = YES;
            }
            
            else if([ctrlEdit isEqualToString:@"Hy_Bgsybyj"]) {
                CGRect frame = CGRectMake(530, 618, 204, 58);
                ...
                CGRect frame = CGRectMake(530, 768, 204, 58);
                ...
                CGRect frame = CGRectMake(530, 928, 204, 58);
                ...
                CGRect frame = CGRectMake(530, 1068, 204, 58);
                ...
                CGRect frame = CGRectMake(530, 1218, 204, 58);
                ...
                CGRect frame = CGRectMake(530, 1368, 208, 100);
...
- (NSDictionary *)getValueData{
    ...
    [dicValues setValue:self.complainTxtView.text forKey:@"Hy_TSSLYJ"];
    [dicValues setValue:self.officeTxtView.text forKey:@"Hy_BGSYJ"];
    [dicValues setValue:self.ldqfTxtView.text forKey:@"Hy_LDYH"];
    [dicValues setValue:self.distriTxtView.text forKey:@"Hy_FFYJ"];
    [dicValues setValue:self.handlerTxtView.text forKey:@"Hy_CLYJ"];
...
- (void)viewDidLoad
{
    ...
    self.complainTxtView1.text = [self.infoDict objectForKey:@"Hy_Xjxxzxybyj_Histroy"];
    ...
    self.handlerTxtView1.text = [self.infoDict objectForKey:@"Hy_Yqblyj_Histroy"];
    self.auditTxtView1.text = [self.infoDict objectForKey:@"Hy_Csryyj_Histroy"];
    self.officeTxtView1.text = [self.infoDict objectForKey:@"Hy_Bgsybyj_Histroy"];
...
-(void)sureContinue
{
    ...
    NSArray *keys = @[ @"Hy_IfLastTache", @"Hy_mdid", @"Hy_docid", @"Hy_userid", @"Hy_LB", @"Hy_NF", @"Hy_BH", @"Hy_DJR", @"Hy_DJRQ", @"Hy_SFGK", @"Hy_BT", @"Hy_HJ", @"Hy_BLQX", @"Hy_ZYNR", @"Hy_TSSLYJ", @"Hy_BGSYJ", @"Hy_LDYH", @"Hy_FFYJ", @"Hy_CLYJ", @"Hy_CSRYYJ", @"Hy_TBYJ", @"Hy_NextTacheId", @"Hy_NextTacheName", @"Hy_NextTacheTransactor", @"Hy_NextTachePasser" ];
    ...
    continueProcessViewController.serviceName = @"ApplicationContinuteProcess";
...
- (void)transferToNextStep{
    ...
    self.webServiceHelper = [[WebServiceHelper alloc] initWithUrl:strURL method:@"ApplicationContinuteProcess" nameSpace:WEBSERVICE_NAMESPACE  parameters:params delegate:self];
...
- (void)saveToProcess{
    ...
    NSDictionary *keyedArguments = [self getValueData];
    NSArray *keys = @[ @"Hy_mdid", @"Hy_docid", @"Hy_userid", @"Hy_LB", @"Hy_NF", @"Hy_BH", @"Hy_DJR", @"Hy_DJRQ", @"Hy_SFGK", @"Hy_BT", @"Hy_HJ", @"Hy_BLQX", @"Hy_ZYNR", @"Hy_TSSLYJ", @"Hy_BGSYJ", @"Hy_LDYH", @"Hy_FFYJ", @"Hy_CLYJ", @"Hy_CSRYYJ", @"Hy_TBYJ" ];
      
    NSString *strURL = [ServiceUrlString generateOAWebServiceUrl];
    NSString *params =  [WebServiceHelper createParametersWithKeys:keys andValues:keyedArguments];
    self.webServiceHelper = [[WebServiceHelper alloc] initWithUrl:strURL method:@"ApplicationSaveProcess" nameSpace:WEBSERVICE_NAMESPACE  parameters:params delegate:self];
...
- (IBAction)modifyData:(UIButton *)sender
{
    ...
    if(tag == 1) {
        ...
        contentEditViewController.editorTitle = @"投诉受理意见";
        contentEditViewController.oldValue = self.complainTxtView.text;
        contentEditViewController.serviceName = @"returnPersonOpinionList";
        self.txtView = self.complainTxtView;
    }
        ...
        //分发意见
        contentEditViewController.editorType = KEditor_Type_SRYJ;
        contentEditViewController.editorTitle = @"分发意见";
        ...
        //办理意见
        contentEditViewController.editorType = KEditor_Type_SRYJ;
        contentEditViewController.editorTitle = @"办理意见";
...
- (void)processWebData:(NSData *)webData andTag:(NSInteger)tag
{
    ...
    if (self.webServiceType == kWebService_SaveProcess) {
        WebDataParserHelper *webDataHelper = [[WebDataParserHelper alloc] initWithFieldName:@"ApplicationSaveProcessReturn" andWithJSONDelegate:self];
        ...
        WebDataParserHelper *webDataHelper = [[WebDataParserHelper alloc] initWithFieldName:@"ApplicationContinuteProcessReturn" andWithJSONDelegate:self];
