...
@implementation PublicOpinionListParser

@synthesize showView,aryItems;
@synthesize webServiceHelper,serviceName,listTableView;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [self.delegate didSelectOpinionListItem:docid process:process];
}
