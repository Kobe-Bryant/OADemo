...
#import "XJZXPMDetailView.h"
#import "UIView+ZXQuartz.h"
@implementation XJZXPMDetailView
...
- (void)drawRect:(CGRect)rect
{
    ...
    [self drawFillRectangel:CGRectMake(385, 71, 138, 278)];
...
//    [self drawLineFrom:CGPointMake(20, 590) to:CGPointMake(748, 590)];
    ...
    [self drawLineFrom:CGPointMake(384, 70) to:CGPointMake(384, 350)];
    [self drawLineFrom:CGPointMake(524, 70) to:CGPointMake(524, 350)];
