...
@interface XJZXPMDetailViewController : BaseViewController<UIAlertViewDelegate,UITableViewDataSource,UITableViewDelegate,WordsDelegate,ContentEditDelegate,PopupDateDelegate,GetOfficeDocumentSNDelegate,UITextViewDelegate> {
}
