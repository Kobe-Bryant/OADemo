...
@interface XJZXPMDetailViewController ()
...
@implementation XJZXPMDetailViewController
    ...
    if ([self.competence isEqualToString:@"0"]) {
        ...
        for (NSString *ctrlEdit in editAry) {
            ...
            self.sitePublicBtn2.enabled = YES;
                ...
                CGRect frame = CGRectMake(530, 358, 204, 110);
...
-(void)sureContinue
{
    ...
    NSArray *keys = @[ @"Hy_mdid", @"Hy_IfLastTache",@"Hy_docid", @"Hy_userid", @"Hy_FWGZ", @"Hy_LDQFM", @"Hy_HQ", @"Hy_ZSDW", @"Hy_CSDW", @"Hy_SFGK",  @"Hy_WZFB", @"Hy_XZSH", @"Hy_ZBDW", @"Hy_NGR",@"Hy_BT", @"Hy_MMDJ", @"Hy_HJ", @"Hy_LB", @"Hy_NF", @"Hy_BH", @"Hy_FS", @"Hy_JDR", @"Hy_YZRQ", @"Hy_TBYJ",@"Hy_NextTacheId",@"Hy_NextTacheName",@"Hy_NextTacheTransactor",@"Hy_NextTachePasser" ];
    ...
    continueProcessViewController.serviceName = @"XJZXPMDocumentContinuteProcess";
...
- (void)transferToNextStep{
    ...
    self.webServiceHelper = [[WebServiceHelper alloc] initWithUrl:strUrl method:@"XJZXPMDocumentContinuteProcess" nameSpace:WEBSERVICE_NAMESPACE  parameters:params delegate:self];
...
- (void)saveToProcess{
    ...
    NSDictionary *keyedArguments = [self getValueData];
    NSArray *keys = @[ @"Hy_mdid", @"Hy_docid", @"Hy_userid", @"Hy_FWGZ",  @"Hy_LDQFM", @"Hy_HQ", @"Hy_ZSDW", @"Hy_CSDW", @"Hy_SFGK", @"Hy_WZFB", @"Hy_XZSH", @"Hy_ZBDW", @"Hy_NGR", @"Hy_BT", @"Hy_MMDJ", @"Hy_HJ", @"Hy_LB", @"Hy_NF", @"Hy_BH", @"Hy_FS", @"Hy_JDR",@"Hy_YZRQ", @"Hy_TBYJ" ];
        
    NSString *strURL = [ServiceUrlString generateOAWebServiceUrl];
    NSString *params = [WebServiceHelper createParametersWithKeys:keys andValues:keyedArguments];
    self.webServiceHelper = [[WebServiceHelper alloc] initWithUrl:strURL method:@"XJZXPMDocumentSaveProcess" nameSpace:WEBSERVICE_NAMESPACE  parameters:params delegate:self];
...
- (IBAction)modifyData:(UIButton *)sender
{
    ...
    if (tag == 0) {
        ...
        contentEditViewController.serviceName = @"XJZXPMDocumentPaper";
        ...
        contentEditViewController.serviceName = @"XJZXPMDocumentUnit";
        ...
        //会签意见
        contentEditViewController.editorType = KEditor_Type_SRYJ;
        contentEditViewController.editorTitle = @"会签";
        ...
        //小组人员意见
        contentEditViewController.editorType = KEditor_Type_SRYJ;
        contentEditViewController.editorTitle = @"小组意见";
...
- (IBAction)selectOfficeDocumentSN:(id)sender{
    ...
    snSelectViewController.serviceName = @"XJZXPMDocumentType";
...
- (void)processWebData:(NSData *)webData
{
    ...
    if (self.webServiceType == kWebService_SaveProcess) {
        WebDataParserHelper *webDataHelper = [[WebDataParserHelper alloc] initWithFieldName:@"XJZXPMDocumentSaveProcessReturn" andWithJSONDelegate:self];
        ...
        WebDataParserHelper *webDataHelper = [[WebDataParserHelper alloc] initWithFieldName:@"XJZXPMDocumentContinuteProcessReturn" andWithJSONDelegate:self];
