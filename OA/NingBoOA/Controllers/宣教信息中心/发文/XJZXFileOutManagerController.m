...
@interface XJZXFileOutManagerController ()
@property (nonatomic,strong) UIPopoverController *popController;
@end

@implementation XJZXFileOutManagerController
...
- (void)viewDidLoad
{
    ...
    self.outListParser.serviceName = @"XJZXHANDLEPOSTDOCUMENT";
...
- (void)returnSelectResult:(NSString *)type selected:(NSInteger)row
{
    ...
    switch (row) {
        ...
        case 2:
            ...
            self.outListParser.type = @"date";
            self.outListParser.serviceName = @"XJZXDonePostDocument";
            self.outListParser.showView = self.view;
            self.outListParser.delegate = self;
            [self.outListParser requestData];
            break;
        ...
        case 4:
            ...
            self.outListParser.serviceName = @"XJZXPostDocumentBackPercent";
            self.outListParser.showView = self.view;
            [self.outListParser requestData];
            break;
        ...
        case 5:
            ...
            self.outListParser.serviceName = @"XJZXInquiryPostDocument";
            self.outListParser.showView = self.view;
            self.outListParser.delegate = self;
            break;
...
- (void)didSelectFileOutListItem:(NSString *)docid process:(NSString *)name{
    ...
    self.webServiceHelper = [[WebServiceHelper alloc] initWithUrl:strUrl method:@"XJZXPostDocumentInfo" nameSpace:WEBSERVICE_NAMESPACE  parameters:params delegate:self];
...
- (void)loadFileOutDetailViewProcess:(NSString *)name competence:(NSString *)status{
    ...
    XJZXFileOutDetailViewController *fileOutDetailViewController = [[XJZXFileOutDetailViewController alloc] initWithNibName:@"XJZXFileOutDetailViewController" bundle:nil];
...
- (void)processWebData:(NSData *)webData
{
    ...
    WebDataParserHelper *webDataHelper = [[WebDataParserHelper alloc] initWithFieldName:@"XJZXPostDocumentInfoReturn" andWithJSONDelegate:self];
