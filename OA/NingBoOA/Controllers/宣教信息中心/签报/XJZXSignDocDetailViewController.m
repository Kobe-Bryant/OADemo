...
@interface XJZXSignDocDetailViewController ()
...
@implementation XJZXSignDocDetailViewController
...
- (NSDictionary *)getValueData{
    ...
    [dicValues setValue:[self.infoDict objectForKey:@"modid"] forKey:@"Hy_mdid"];
    ...
    [dicValues setValue:self.auditTxtView.text forKey:@"Hy_XZSH"];
    [dicValues setValue:self.officeTxtView.text forKey:@"Hy_ZHZSH"];
...
-(void)sureContinue
{
    ...
    NSArray *keys = @[ @"Hy_mdid", @"Hy_IfLastTache", @"Hy_docid", @"Hy_userid", @"Hy_FWGZ", @"Hy_LDQFM", @"Hy_HQ", @"Hy_ZSDW", @"Hy_CSDW", @"Hy_SFGK",  @"Hy_WZFB", @"Hy_XZSH", @"Hy_ZHZSH",@"Hy_ZBDW", @"Hy_NGR",@"Hy_BT", @"Hy_MMDJ", @"Hy_HJ", @"Hy_LB", @"Hy_NF", @"Hy_BH", @"Hy_FS", @"Hy_JDR", @"Hy_YZRQ", @"Hy_TBYJ", @"Hy_NextTacheId", @"Hy_NextTacheName", @"Hy_NextTacheTransactor", @"Hy_NextTachePasser" ];
    ...
    continueProcessViewController.serviceName = @"XJZXSignReportContinuteProcess";
...
- (void)transferToNextStep{
    ...
    self.webServiceHelper = [[WebServiceHelper alloc] initWithUrl:strUrl method:@"XJZXSignReportContinuteProcess" nameSpace:WEBSERVICE_NAMESPACE  parameters:params delegate:self];
...
- (void)saveToProcess{
    ...
    NSArray *keys = @[ @"Hy_mdid", @"Hy_docid", @"Hy_userid", @"Hy_FWGZ", @"Hy_LDQFM", @"Hy_HQ", @"Hy_ZSDW", @"Hy_CSDW", @"Hy_SFGK", @"Hy_WZFB", @"Hy_XZSH", @"Hy_ZHZSH", @"Hy_ZBDW", @"Hy_NGR", @"Hy_BT", @"Hy_MMDJ", @"Hy_HJ", @"Hy_LB", @"Hy_NF", @"Hy_BH", @"Hy_FS", @"Hy_JDR", @"Hy_YZRQ", @"Hy_TBYJ"];
    
    NSString *strURL = [ServiceUrlString generateOAWebServiceUrl];
    NSString *params = [WebServiceHelper createParametersWithKeys:keys andValues:keyedArguments];
    self.webServiceHelper = [[WebServiceHelper alloc] initWithUrl:strURL method:@"XJZXSignReportSaveProcess" nameSpace:WEBSERVICE_NAMESPACE  parameters:params delegate:self];
...
- (IBAction)modifyData:(UIButton *)sender
{
    ...
    if (tag == 0) {
        ...
        contentEditViewController.serviceName = @"XJZXSignReportPaper";
        ...
        contentEditViewController.serviceName = @"XJZXSignReportUnit";
        ...
        //小组审核
        contentEditViewController.editorType = KEditor_Type_SRYJ;
        contentEditViewController.editorTitle = @"小组审核";
        ...
        //综合组审核
        contentEditViewController.editorType = KEditor_Type_SRYJ;
        contentEditViewController.editorTitle = @"综合组审核";
...
- (IBAction)selectOfficeDocumentSN:(id)sender{
    ...
    snSelectViewController.serviceName = @"XJZXSignReportType";
...
- (void)processWebData:(NSData *)webData
{
    ...
    if (self.webServiceType == kWebService_SaveProcess) {
        WebDataParserHelper *webDataHelper = [[WebDataParserHelper alloc] initWithFieldName:@"XJZXSignReportSaveProcessReturn" andWithJSONDelegate:self];
        ...
        WebDataParserHelper *webDataHelper = [[WebDataParserHelper alloc] initWithFieldName:@"XJZXSignReportContinuteProcessReturn" andWithJSONDelegate:self];
