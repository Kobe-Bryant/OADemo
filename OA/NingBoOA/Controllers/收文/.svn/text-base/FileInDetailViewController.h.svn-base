...
@interface FileInDetailViewController : BaseViewController<UIAlertViewDelegate,HandleGWDelegate,UITableViewDataSource,UITableViewDelegate,PopupDateDelegate,GetOfficeDocumentSNDelegate,WordsDelegate,ContentEditDelegate,UITextViewDelegate>
