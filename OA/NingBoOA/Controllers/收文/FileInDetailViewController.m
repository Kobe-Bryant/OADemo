...
- (void)setControlEdit{
    ...
    [scrollView setContentSize:CGSizeMake(768, 1330)];
    ...
    if ([self.competence isEqualToString:@"0"]) {
        ...
        for (NSString *ctrlEdit in editAry) {
            ...
            if ([ctrlEdit isEqualToString:@"Hy_FWGZ"]) {
                ...
                CGRect frame = CGRectMake(170, 392, 532, 55);
                ...
                CGRect frame = CGRectMake(170, 539, 532, 55);
                ...
                CGRect frame = CGRectMake(530, 888, 208, 100);
...
- (NSDictionary *)getValueData{
    ...
    [dicValues setValue:self.auditTxtView.text forKey:@"Hy_CSYJ"];
...
-(void)sureContinue
{
    ...
    NSArray *keys = @[ @"Hy_mdid", @"Hy_IfLastTache",@"Hy_docid", @"Hy_userid", @"Hy_SWLY", @"Hy_YEAR", @"Hy_BH", @"Hy_DJR", @"Hy_DJRQ", @"Hy_MJ", @"Hy_SWRQ", @"Hy_HJ", @"Hy_LB", @"Hy_BT", @"Hy_LZFS",@"Hy_LWLB", @"Hy_LWNF", @"Hy_LWBH", @"Hy_pages", @"Hy_numbers", @"Hy_SFGD", @"Hy_BLQX", @"Hy_BGSYJ", @"Hy_LDYJ", @"Hy_SWFFYJ", @"Hy_CSYJ", @"Hy_TBYJ", @"Hy_NextTacheId", @"Hy_NextTacheName", @"Hy_NextTacheTransactor", @"Hy_NextTachePasser" ];
    ...
    continueProcessViewController.serviceName = @"FileInContinuteProcess";
...
- (void)transferToNextStep{
    ...
    self.webServiceHelper = [[WebServiceHelper alloc] initWithUrl:strURL method:@"FileInContinuteProcess" nameSpace:WEBSERVICE_NAMESPACE  parameters:params delegate:self];
...
- (void)saveToProcess{
    ...
    NSDictionary *keyedArguments = [self getValueData];
    NSArray *keys = @[ @"Hy_mdid", @"Hy_docid", @"Hy_userid", @"Hy_SWLY", @"HY_YEAR", @"Hy_BH", @"Hy_DJR", @"Hy_DJRQ", @"Hy_MJ", @"Hy_SWRQ", @"Hy_HJ", @"Hy_LB", @"Hy_BT", @"Hy_LZFS", @"Hy_LWLB", @"Hy_LWNF", @"Hy_LWBH", @"Hy_pages", @"Hy_numbers", @"Hy_SFGD", @"Hy_BLQX", @"Hy_BGSYJ", @"Hy_LDYJ", @"Hy_SWFFYJ", @"Hy_CSYJ", @"Hy_TBYJ" ];
      
    NSString *strURL = [ServiceUrlString generateOAWebServiceUrl];
    NSString *params =  [WebServiceHelper createParametersWithKeys:keys andValues:keyedArguments];
    self.webServiceHelper = [[WebServiceHelper alloc] initWithUrl:strURL method:@"FileInSaveProcess" nameSpace:WEBSERVICE_NAMESPACE  parameters:params delegate:self];
...
- (IBAction)selectOfficeDocumentSN:(id)sender{
    ...
    snSelectViewController.serviceName = @"GetFileInResource";
