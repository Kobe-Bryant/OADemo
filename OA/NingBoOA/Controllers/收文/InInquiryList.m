...
//  NingBoOA
//
//  Created by ZHONGWEN on 13-11-21.
...
- (void)requestData{
    ...
    NSString *swh = [self.paramDict objectForKey:@"swh"];
    NSString *lwwh = [self.paramDict objectForKey:@"lwwh"];
    NSString *lwdw = [self.paramDict objectForKey:@"lwdw"];
    ...
    NSString *params = [WebServiceHelper createParametersWithKey:@"Hy_userid" value:self.user,@"HY_TS",ONE_PAGE_SIZE,@"HY_START",[NSString stringWithFormat:@"%d",self.start],@"HY_QSSJ",beginDate,@"Hy_JZSJ",endDate,@"Hy_year",year,@"Hy_receiveid",swh,@"Hy_postid",lwwh,@"Hy_DEPART",lwdw,@"Hy_TITLE",title,@"Hy_urgent",urgent,nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (self.notSearch) {
        ...
        dateLabel.text = [tmpDict objectForKey:@"swrq"];
        
        UILabel *swlyLabel = (UILabel *)[cell viewWithTag:104];
        swlyLabel.text = [tmpDict objectForKey:@"swly"];
        
        UILabel *swhLabel = (UILabel *)[cell viewWithTag:105];
        swhLabel.text = [tmpDict objectForKey:@"swh"];
        
        UILabel *lwwhLabel = (UILabel *)[cell viewWithTag:106];
        lwwhLabel.text = [tmpDict objectForKey:@"lwwh"];
        
        UILabel *urgentLabel = (UILabel *)[cell viewWithTag:107];
