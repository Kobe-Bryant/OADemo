...
+(UITableViewCell*)makeSubCell:(UITableView *)tableView
					 withTitle:(NSString *)aTitle
						 value:(NSString *)aValue
                     andHeight:(CGFloat)theHeight
                 andIdentifier:(NSString *)cellIdentifier
{
	UILabel* lblTitle = nil;
	UILabel* lblValue = nil;
	UITableViewCell *aCell = [tableView dequeueReusableCellWithIdentifier:cellIdentifier];
...

{
	...
	if (lblTitle == nil) {
		CGRect tRect1 = CGRectMake(10, 0, 250, 23);
		...
		lbl3.font = [UIFont fontWithName:@"Helvetica" size:18.0];
                    ...
                    andNoteCount:(NSInteger)num
{
    ...
    tRect3 = CGRectMake(380, 48, 200, 24);
    tRect4 = CGRectMake(500, 48, 200, 24);
    tRect5 = CGRectMake(500, 25, 200, 24);
    tRect6 = CGRectMake(210, 48, 200, 24);
	...
	if (aCell.contentView != nil)
	{
        ...
        lblFDate = (UILabel *)[aCell.contentView viewWithTag:17];
	}
	...
	if (lblTitle == nil) {
		...
		lblCDate.textAlignment = NSTextAlignmentLeft;
		lblCDate.tag = 13;
		[aCell.contentView addSubview:lblCDate];
        ...
        lblFDate = [[UILabel alloc] initWithFrame:tRect6]; //此处使用id定义任何控件对象
		[lblFDate setBackgroundColor:[UIColor clearColor]];
		[lblFDate setTextColor:[UIColor grayColor]];
        lblFDate.highlightedTextColor = [UIColor whiteColor];
		lblFDate.font = [UIFont fontWithName:@"Helvetica" size:15.0];
		lblFDate.textAlignment = NSTextAlignmentLeft;
		lblFDate.tag = 14;
		[aCell.contentView addSubview:lblFDate];
        ...
        lblFDate.backgroundColor = [UIColor clearColor];
	}
    ...
    if (lblEDate != nil)	[lblEDate setText:aEDate];
    if (lblMode != nil)     [lblMode setText:aMode];
    if (lblFDate != nil)     [lblFDate setText:aFDate];
...
+ (UITableViewCell *)makeSubCell:(UITableView *)tableView withTitle:(NSString *)aTitle andSubTitle:(NSString *)aSubTitle andNoteCount:(NSInteger)aNum
{
    CGRect tRect1 = CGRectMake(40, 3, 640, 48);
    CGRect tRect2 = CGRectMake(40, 48, 640, 24);
    CGRect tRect0 = CGRectMake(0, 3, 40, 72);
    NSString *cellIdentifier = @"cell_portraitTZList";
	...
	{
		lblTitle = (UILabel *)[aCell.contentView viewWithTag:11];
		lblSubTitle = (UILabel *)[aCell.contentView viewWithTag:12];
        lblNum = (UILabel *)[aCell.contentView viewWithTag:13];
	}
	...
	if (lblTitle == nil)
    {
		...
		lblSubTitle = [[UILabel alloc] initWithFrame:tRect2]; //此处使用id定义任何控件对象
		[lblSubTitle setBackgroundColor:[UIColor clearColor]];
		[lblSubTitle setTextColor:[UIColor grayColor]];
        lblSubTitle.highlightedTextColor = [UIColor whiteColor];
		lblSubTitle.font = [UIFont fontWithName:@"Helvetica" size:15.0];
		lblSubTitle.textAlignment = UITextAlignmentLeft;
		lblSubTitle.tag = 12;
		[aCell.contentView addSubview:lblSubTitle];
	...
	if (lblTitle != nil)	[lblTitle setText:aTitle];
	if (lblSubTitle != nil) [lblSubTitle setText:aSubTitle];
    if (lblNum != nil)      [lblNum setText:[NSString stringWithFormat:@"%d",aNum]];
