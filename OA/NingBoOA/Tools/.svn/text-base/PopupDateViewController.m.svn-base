...
@synthesize delegate,myPicker,datePickerMode,date;
...
- (void)viewDidLoad {
    ...
    [super viewDidLoad];
	self.contentSizeForViewInPopover = CGSizeMake(268, 196.0);
	UIDatePicker *picker = [[UIDatePicker alloc] initWithFrame:CGRectMake(10, 0, 248, 162)];
